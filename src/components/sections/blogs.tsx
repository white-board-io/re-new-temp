          ...
          {posts.map((post) => (
            ...
            >
              <Image
                ...
                width={1100}
                height={730}
                className="aspect-[1.44/1] w-full object-cover"
              ...
              <div className="flex flex-1 flex-col p-8 lg:px-12 lg:py-10">
                ...
                <a
                  ...
                  className="mt-10 inline-flex w-fit items-center justify-center rounded-full border-2 border-primary-700 px-10 py-2 text-lg font-bold text-primary-700 transition-colors hover:bg-primary-700 hover:text-white"
                >
                  Read more
                </a>
              </div>
