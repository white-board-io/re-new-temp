...
export function EnquireFab() {
  return (
    ...
    <div className="design-scale-fixed-bottom group pointer-events-none fixed bottom-0 right-2 z-40 h-[76px] w-[146px] origin-bottom-right scale-[0.72] sm:right-4 sm:scale-100 lg:right-16">
      <Sunburst />
      <ContactModalTrigger
